...
<body>
    <div class="container">
        <div class="header">
            <h1>PURCHASE ORDER STATUS UPDATE</h1>
        ...
        <div class="alert-info">
            @php
                $statusMessages = [
                    ...
                    'Shipped' => 'All items have been shipped and are on their way.',
        ...
        <div class="po-info">
            ...
            <table class="po-details-table">
                ...
                @if ($purchaseProduct->expected_delivery_date)
                    <tr>
                        <td class="po-info-label">Expected Delivery</td>
                        <td class="po-info-value">: {{ $purchaseProduct->expected_delivery_date->format('d M Y') }}
                        </td>
                    </tr>
                @endif
            </table>
