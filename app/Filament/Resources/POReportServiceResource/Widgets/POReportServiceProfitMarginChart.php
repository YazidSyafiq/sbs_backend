...
class POReportServiceProfitMarginChart extends ChartWidget
{
    protected static ?string $heading = 'Service Profit Margin Trends';
    ...
    protected function getData(): array
    {
        ...
        return [
            'datasets' => [
                [
                    'label' => 'Realized Service Profit Margin',
                    'data' => $margins,
    ...
    {
        $filters = session('po_service_filters', []);
        return 'Realized Service Profit Margin Performance (' . POReportService::getPeriodLabel($filters) . ')';
    }

    public function getDescription(): ?string
    {
        return 'Service profit margin percentage trends from paid orders only';
    }
}
